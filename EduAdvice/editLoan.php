...
<html lang="en">
    ...
    <script>
                ...
                window.location.replace("loan.php?loanid=" + a +"&lname=" + lname + "&pname=" + pname + "&lrate=" + lrate );
                }
    </script>
    <body>
        <!-- Preloader -->
                                ...
                                <div class="table-responsive" id="userTable">
                                    ...
                                    <table id="example"  cellspacing="0" width="100%" class="table " >
                                        ...
                                        <tr>
                                            ...
                                            <td><input type='text' name='intent' id='lname' value={$val['loan_name']}  class='form-control' required/></td>
                                            <td><input type='text' name='intent' id='pname' value='{$val['provider_name']}'  class='form-control' required/></td>
                                            <td><input type='text' name='intent' id='lrate'  value={$val['interest_rate']} class='form-control' required/></td>
