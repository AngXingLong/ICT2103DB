...
if (isset($_GET['courseid']) && isset($_GET['fname']) && isset($_GET['fcat'])) {
    $a = $_GET['courseid'];
    $fname = $_GET['fname'];
    $fcat = $_GET['fcat'];
    doUpdatefaculty($fname, $fcat, $a);
...
<html lang="en">
    ...
    <script>
                ...
                function edit(a) {
                         window.location.replace("editFaculty.php?courseid=" + a);
                }
    </script>
    </head>
                    ...
                    <div class="row" style="margin-top:15px;">
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <p>
                                    <button class="fa fa-plus-circle btn btn-primary" id="myBtn" data-toggle="modal" data-target="#myModal"> New Faculty</button></p>
                                                ...
                                                <article role="login">
                                                    ...
                                                    <form class="form-signin" method="post" id="register_form">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <label class="col-md-5 control-label">Faculty name</label>
                                                            <div class="col-md-7">
                                    ...
                                    <table id="example"  cellspacing="0" width="100%" class="table " >
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($allcourses as $seq => $val) {
                                                ...
                                                if (in_array($val['faculty_name'], $a)){
                                                    
                                                }else{
                                                    array_push($a,$val['faculty_name']);
                                                    $ind +=1;
                                                echo "<script>
                                            ...
                                            <td>{$val['faculty_category']}</td>";
                                            $name = $val['faculty_name'];
                                ...
                                if (isset($_POST['delFaculty'])) {
                                    ...
                                    echo'<p>Are you sure you want to delete this faculty?</p>';
                                    echo'<form action = "deleteFromDB/deleteFaculty.php" method = "POST"';
                                    echo'<div class="form-group" style="min-height: 100px;">';
                                    echo'<button type = "submit" id = "btn-submit" class = "btn btn-danger" style="margin-right:10px;" name = "cfmDelFaculty" value = "' . $_POST['delFaculty'] . '">Confirm</button>';
