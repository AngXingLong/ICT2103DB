...
<html lang="en">
    ...
    <script>
                ...
                window.location.replace("faculty.php?courseid=" + a +"&fname=" + fname + "&fcat=" + fcat);
                }
    </script>
    </head>
                                ...
                                <div class="table-responsive" id="userTable">
                                    ...
                                    <table id="example"  cellspacing="0" width="100%" class="table " >
                                        ...
                                        <tbody>
                                            ...
                                            <td><input type='text' name='intent' id='fcat' value='{$val['faculty_category']}'  class='form-control' required/></td>
