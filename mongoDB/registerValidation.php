...
$userId = $pwd = $cfmPwd = $accountType = $firstName = $lastName = $fullName = "";
...
if($valid){
    ...
    $result = mysqli_query($conn, "INSERT INTO accounts(account_name, account_type_id, account_password, first_name, last_name, full_name)"
                                ."VALUES('$userId', '$accountType', '$pwd', '$firstName', '$lastName', '$fullName')");
