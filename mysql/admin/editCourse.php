...
<html lang="en">
    ...
    <script>
                ...
                window.location.replace("courses.php?courseid=" + a +"&cname=" + cname + "&sname=" + sname + "&fname=" + fname + "&msal=" + msal+ "&fee=" + fee+ "&years=" + years );
                }
    </script>
    <body>
        <!-- Preloader -->
                    ...
                    <div class="row" style="margin-top:15px;">
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <p><button class="fa fa-plus-circle btn btn-primary" id="myBtn" data-toggle="modal" data-target="#myModal"> New Course</button></p>
                                    ...
                                    <table id="example"  cellspacing="0" width="100%" class="table " >
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($allcourses as $seq => $val) {
                                                if ($val['course_id'] == $a){
                                                     echo "<script>
                                          var user{$seq}='{$val['course_id']}'; 
                                      </script>
                                        <tr>
                                            <td>$seq</td>
                                                
                                            <td><input type='text' name='intent' id='cname' value={$val['course_name']}  class='form-control' required/></td>
                                            <td><input type='text' name='intent' id='sname' value='{$val['school_name']}'  class='form-control' required/></td>
                                            <td><input type='text' name='intent' id='fname'  value={$val['faculty_name']} class='form-control' required/></td>
                                            <td><input type='text' name='intent' id='msal' value={$val['mean_salary']} class='form-control' required/></td>
                                            <td><input type='text' name='intent' id='fee'  value={$val['course_fee']}  class='form-control' required/></td>    
                                            <td><input type='text' name='intent' id='years'  value={$val['year_of_study']}  class='form-control' required/></td>  
                                            <td><button class='btn btn-primary glyphicon glyphicon-book' id='{$val['course_id']}' onclick='save(id)'></button></td>
                                            <td><button class='btn btn-danger fa fa-trash-o' name='delete' value='{$val['course_id']}'></button></td>
                                                </tr>";
                                                }else{
                                                 echo "<script>
                                          var user{$seq}='{$val['course_id']}'; 
                                        ...
                                        <tr>
                                            ...
                                            <td><button class='btn btn-primary fa fa-pencil-square-o' id='{$val['course_id']}' onclick='edit(id)'></button></td>
