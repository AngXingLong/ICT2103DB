                    ...
                    <div class="row" style="margin-top:15px;">
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <p><button class="fa fa-plus-circle btn btn-primary" id="myBtn" data-toggle="modal" data-target="#myModal"> New Loan</button></p>
                                ...
                                <!-- Populate table -->
                                <?php include "retrieveFromDB/retrieveLoans.php"; ?>
                                
                                <!-- Delete Confirmation Model -->
                                <?php
                                if (isset($_POST['delLoan'])) {
                                    ...
                                    echo'<form action = "deleteFromDB/deleteLoan.php" method = "POST"';
                                    echo'<div class="form-group" style="min-height: 100px;">';
                                    echo'<button type = "submit" id = "btn-submit" class = "btn btn-danger" style="margin-right:10px;" name = "cfmDelLoan" value = "' . $_POST['delLoan'] . '">Confirm</button>';
