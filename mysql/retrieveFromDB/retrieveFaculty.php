...
if(mysqli_num_rows($result) > 0){
    ...
    while($rows = mysqli_fetch_assoc($result)){
        ...
        echo'<td>'.$rows["faculty_category"].'</td>';

        //Edit Button
        echo'<form action="faculty.php" method="POST">';
        echo'<td><button class="btn btn-info fa fa-pencil-square-o" name="edit" value="'.$rows["faculty_id"].'"></button></td>';
        echo'</form>';
        
        //Delete Button
        echo'<form action="faculty.php" method="POST">';
        echo'<td><button class="btn btn-danger fa fa-trash-o" name="delFaculty" value="'.$rows["faculty_id"].'"></button></td>';
        echo'</form>';
