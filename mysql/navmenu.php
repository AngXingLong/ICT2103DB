...
function getHeader($js = array(), $css = array(), $padding = true){
  ...
  foreach ($js as $v) {
    echo "<script src='$v'></script>";
      ...
      echo '</button>';
      echo '<a class="navbar-brand" href="index.php">EduAdvice</a>';
      ...
      if (isset($_SESSION['user_type']))
      {
        ...
        echo  "<div style='color:#fff; margin-right:20px;'>Welcome ".$_SESSION["user_name"]."!</div>";
        echo '<button class="btn btn-info my-2 my-sm-0" type="submit">Log Out</button>';
        echo '</form>';
      }
      else{
...
function createBasicTable($tableHeaders, $tableRows){
